...
songs = [
    ...
    ['We Can Fly!!!!', [24], 1, 's93k_P__Ds.mp3'],
    ['LUNΛ Labyrinth', [24], 1, 'w6YkiqgrU8A.mp3'],
    ['Whispers\' Hope', [24], 1, '2xkvubO4DwM.mp3'],
    ['HARU・NARU', [24], 1, '18GoGDnz94.mp3'],
    ['イロドリハート', [24], 1, 'H6P9liQBc0.mp3'],
